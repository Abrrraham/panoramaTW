...
export const useRouteStore = defineStore(SetupStoreId.Route, () => {
   ...
   * "@elegant-router/vue"
   */
  // 按环境变量决定路由模式，默认使用 static，恢复本地生成的完整页面集合
  const authRouteMode = ref<'static' | 'dynamic'>((import.meta.env.VITE_AUTH_ROUTE_MODE as any) || 'static');
